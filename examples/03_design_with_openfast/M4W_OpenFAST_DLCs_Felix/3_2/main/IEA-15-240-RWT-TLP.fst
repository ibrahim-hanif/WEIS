------- OpenFAST INPUT FILE -------------------------------------------
IEA 15 MW offshore reference model TLP configuration
---------------------- SIMULATION CONTROL --------------------------------------
...
"IEA-15-240-RWT-TLP_AeroDyn15.dat"  AeroFile    - Name of file containing aerodynamic input parameters (quoted string)
"IEA-15-240-RWT-TLP_ServoDyn.dat"   ServoFile   - Name of file containing control and electrical-drive input parameters (quoted string)
...
"IEA-15-240-RWT-TLP_MoorDyn.dat"                 MooringFile - Name of file containing mooring system input parameters (quoted string)
